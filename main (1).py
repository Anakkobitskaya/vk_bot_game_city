...
vk_session = vk_api.VkApi(token="711501fe8f30b5f6b0c571c06598b2d24236477156a21bded7887da9c56a0b4c60b4b43ae9f706f75e276")
        ...
        if is_message(event):
            if is_play_game(event):
                ...
                if not igra.is_unused_city(city):
                    send_message(user1, 'Ты проиграл, так как ты назвал город, который уже был назван')
                    send_message(user2, 'Ты победил')
                    kill_game(igra)
